...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            ...
            <a onclick="addForm()" class="btn btn-success pull-right" style="margin-top: -8px;"><i class="fa fa-plus"></i> Add Items</a>
        </div>
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('items') }}";
                    else url = "{{ url('items') . '/' }}" + id;
