                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button onclick="downloadQR('{{ $item->id }}', '{{ $item->name }}')" class="btn btn-xs btn-default">
...
<script>
    ...
    // Clone the SVG so we don't mess up the UI while resizing for high-res
    ...
    downloadLink.download = `QR_${name.replace(/[^a-z0-9]/gi, '_').toLowerCase()}.png`;
